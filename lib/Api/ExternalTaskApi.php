...
class ExternalTaskApi
{
     ...
     * @param  \OpenAPI\Client\Model\CompleteExternalTaskDto $complete_external_task_dto complete_external_task_dto (optional)
     *
     ...
     *
     * @param  string $id The id of the task to complete. (required)
     * @param  \OpenAPI\Client\Model\CompleteExternalTaskDto $complete_external_task_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @param  \OpenAPI\Client\Model\ExtendLockOnExternalTaskDto $extend_lock_on_external_task_dto extend_lock_on_external_task_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \OpenAPI\Client\Model\ExtendLockOnExternalTaskDto $extend_lock_on_external_task_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * Fetch and Lock
     *
     * @param  \OpenAPI\Client\Model\FetchExternalTasksDto $fetch_external_tasks_dto fetch_external_tasks_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\LockedExternalTaskDto[]|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * Fetch and Lock
     *
     * @param  \OpenAPI\Client\Model\FetchExternalTasksDto $fetch_external_tasks_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\LockedExternalTaskDto[]|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function fetchAndLockWithHttpInfo($fetch_external_tasks_dto = null)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\LockedExternalTaskDto[]' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\LockedExternalTaskDto[]', []),
            ...
            $returnType = '\OpenAPI\Client\Model\LockedExternalTaskDto[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\LockedExternalTaskDto[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ExternalTaskDto|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ExternalTaskDto|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExternalTaskWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ExternalTaskDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ExternalTaskDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 404:
            ...
            $returnType = '\OpenAPI\Client\Model\ExternalTaskDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ExternalTaskDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \DateTime $lock_expiration_after Restrict to external tasks that have a lock that expires after a given date. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     * @param  \DateTime $lock_expiration_before Restrict to external tasks that have a lock that expires before a given date. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format &#x60;yyyy-MM-dd&#39;T&#39;HH:mm:ss.SSSZ&#x60;, e.g., &#x60;2013-01-23T14:42:45.000+0200&#x60;. (optional)
     ...
     * @param  \OpenAPI\Client\Model\ExternalTaskBpmnError $external_task_bpmn_error external_task_bpmn_error (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task in which context a BPMN error is reported. (required)
     * @param  \OpenAPI\Client\Model\ExternalTaskBpmnError $external_task_bpmn_error (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \OpenAPI\Client\Model\ExternalTaskFailureDto $external_task_failure_dto external_task_failure_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task to report a failure for. (required)
     * @param  \OpenAPI\Client\Model\ExternalTaskFailureDto $external_task_failure_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \OpenAPI\Client\Model\LockExternalTaskDto $lock_external_task_dto lock_external_task_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the external task. (required)
     * @param  \OpenAPI\Client\Model\LockExternalTaskDto $lock_external_task_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \OpenAPI\Client\Model\ExternalTaskQueryDto $external_task_query_dto external_task_query_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ExternalTaskDto[]|\OpenAPI\Client\Model\ExceptionDto
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \OpenAPI\Client\Model\ExternalTaskQueryDto $external_task_query_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ExternalTaskDto[]|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     * Set Retries Sync
     *
     * @param  \OpenAPI\Client\Model\SetRetriesForExternalTasksDto $set_retries_for_external_tasks_dto set_retries_for_external_tasks_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Set Retries Sync
     *
     * @param  \OpenAPI\Client\Model\SetRetriesForExternalTasksDto $set_retries_for_external_tasks_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
