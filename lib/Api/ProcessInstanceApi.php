...
class ProcessInstanceApi
{
     ...
     *
     * @param  \OpenAPI\Client\Model\DeleteProcessInstancesDto $delete_process_instances_dto **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     *
     ...
     * Delete Async (POST)
     *
     * @param  \OpenAPI\Client\Model\DeleteProcessInstancesDto $delete_process_instances_dto **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ActivityInstanceDto|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ActivityInstanceDto|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getActivityInstanceTreeWithHttpInfo($id)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ActivityInstanceDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ActivityInstanceDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\OpenAPI\Client\Model\ActivityInstanceDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\ActivityInstanceDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ProcessInstanceDto|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ProcessInstanceDto|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  \OpenAPI\Client\Model\ProcessInstanceModificationDto $process_instance_modification_dto process_instance_modification_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $id The id of the process instance to modify. (required)
     * @param  \OpenAPI\Client\Model\ProcessInstanceModificationDto $process_instance_modification_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto|\OpenAPI\Client\Model\AuthorizationExceptionDto|\OpenAPI\Client\Model\ExceptionDto
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto|\OpenAPI\Client\Model\AuthorizationExceptionDto|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \OpenAPI\Client\Model\ProcessInstanceQueryDto $process_instance_query_dto process_instance_query_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ProcessInstanceDto[]|\OpenAPI\Client\Model\ExceptionDto
     ...
     * @param  int $first_result Pagination of results. Specifies the index of the first result to return. (optional)
     * @param  int $max_results Pagination of results. Specifies the maximum number of results to return. Will return less results if there are no more results left. (optional)
     * @param  \OpenAPI\Client\Model\ProcessInstanceQueryDto $process_instance_query_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ProcessInstanceDto[]|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \OpenAPI\Client\Model\SetJobRetriesByProcessDto $set_job_retries_by_process_dto Please note that if both processInstances and processInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;historicProcessInstanceQuery&#x60; (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto
     ...
     *
     * @param  \OpenAPI\Client\Model\SetJobRetriesByProcessDto $set_job_retries_by_process_dto Please note that if both processInstances and historicProcessInstanceQuery are provided, then the resulting execution will be performed on the union of these sets. **Unallowed property**: &#x60;processInstanceQuery&#x60; (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto
     ...
     *
     * @param  \OpenAPI\Client\Model\SetVariablesAsyncDto $set_variables_async_dto set_variables_async_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto|\OpenAPI\Client\Model\AuthorizationExceptionDto
     */
     ...
     * Set Variables Async (POST)
     *
     * @param  \OpenAPI\Client\Model\SetVariablesAsyncDto $set_variables_async_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto|\OpenAPI\Client\Model\AuthorizationExceptionDto, HTTP status code, HTTP response headers (array of strings)
     */
     ...
     *
     * @param  \OpenAPI\Client\Model\ProcessInstanceSuspensionStateDto $process_instance_suspension_state_dto process_instance_suspension_state_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     * Activate/Suspend In Group
     *
     * @param  \OpenAPI\Client\Model\ProcessInstanceSuspensionStateDto $process_instance_suspension_state_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  \OpenAPI\Client\Model\ProcessInstanceSuspensionStateAsyncDto $process_instance_suspension_state_async_dto process_instance_suspension_state_async_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto
     ...
     * Activate/Suspend In Batch
     *
     * @param  \OpenAPI\Client\Model\ProcessInstanceSuspensionStateAsyncDto $process_instance_suspension_state_async_dto (optional)
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\BatchDto|\OpenAPI\Client\Model\ExceptionDto, HTTP status code, HTTP response headers (array of strings)
