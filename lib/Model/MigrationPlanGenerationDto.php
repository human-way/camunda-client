 ...
 */
class MigrationPlanGenerationDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MigrationPlanGenerationDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['update_event_triggers'] = $data['update_event_triggers'] ?? null;
     ...
     *
     * @param bool|null $update_event_triggers A boolean flag indicating whether instructions between events should be configured to update the event triggers.
     *
     * @return self
     */
