...
class ProcessInstanceQueryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'or_queries' => '\OpenAPI\Client\Model\ProcessInstanceQueryDto[]',
        'sorting' => '\OpenAPI\Client\Model\ProcessInstanceQueryDtoSorting[]'
    ];
     ...
     * Sets variables
     *
     * @param \OpenAPI\Client\Model\VariableQueryParameterDto[]|null $variables A JSON array to only include process instances that have variables with certain values. The array consists of objects with the three properties `name`, `operator` and `value`. `name` (String) is the variable name, `operator` (String) is the comparison operator to be used and `value` the variable value. The `value` may be String, Number or Boolean.  Valid operator values are: `eq` - equal to; `neq` - not equal to; `gt` - greater than; `gteq` - greater than or equal to; `lt` - lower than; `lteq` - lower than or equal to; `like`.
     *
     * @return self
     */
     ...
     * Gets sorting
     *
     * @return \OpenAPI\Client\Model\ProcessInstanceQueryDtoSorting[]|null
     */
     ...
     * Sets sorting
     *
     * @param \OpenAPI\Client\Model\ProcessInstanceQueryDtoSorting[]|null $sorting Apply sorting of the result
     *
     * @return self
     */
