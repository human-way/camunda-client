...
class TaskDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets created
     *
     * @param \DateTime|null $created The date the task was created on. [Default format](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
