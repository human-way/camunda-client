...
class StartProcessInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'start_instructions' => '\OpenAPI\Client\Model\ProcessInstanceModificationInstructionDto[]',
     ...
     * Sets variables
     *
     * @param array<string,\OpenAPI\Client\Model\VariableValueDto>|null $variables variables
     *
     * @return self
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ProcessInstanceModificationInstructionDto[]|null $start_instructions **Optional**. A JSON array of instructions that specify which activities to start the process instance at. If this property is omitted, the process instance starts at its default blank start event.
     *
     * @return self
     */
