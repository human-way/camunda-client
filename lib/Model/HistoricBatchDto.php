 ...
 */
class HistoricBatchDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricBatchDto';
     ...
     * Sets create_user_id
     *
     * @param string|null $create_user_id The batch creator's user id.
     *
     * @return self
     */
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The time the batch was started. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further information, please see the [documentation](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/)
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time The time the batch ended. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further information, please see the [documentation](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/)
     *
     * @return self
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the historic batch should be removed by the History Cleanup job. Default format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`. For further information, please see the [documentation](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/)
     *
     * @return self
     */
