 ...
 */
class HistoricDetailDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricDetailDto';
     ...
     * Sets id
     *
     * @param string|null $id The id of the historic detail.
     *
     * @return self
     */
     ...
     * Sets type
     *
     * @param string|null $type The type of the historic detail. Either `formField` for a submitted form field value or `variableUpdate` for variable updates.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_key The key of the process definition that this historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_id The id of the process definition that this historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_instance_id The id of the process instance the historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $activity_instance_id The id of the activity instance the historic detail belongs to.
     *
     * @return self
     */
     ...
     * Sets execution_id
     *
     * @param string|null $execution_id The id of the execution the historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_definition_key The key of the case definition that this historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_definition_id The id of the case definition that this historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_instance_id The id of the case instance the historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_execution_id The id of the case execution the historic detail belongs to.
     *
     * @return self
     */
     ...
     * Sets task_id
     *
     * @param string|null $task_id The id of the task the historic detail belongs to.
     *
     * @return self
     */
     ...
     * Sets tenant_id
     *
     * @param string|null $tenant_id The id of the tenant that this historic detail belongs to.
     *
     * @return self
     */
     ...
     *
     * @param string|null $user_operation_id The id of user operation which links historic detail with [user operation log](https://docs.camunda.org/manual/latest/reference/rest/history/user-operation-log/) entries.
     *
     * @return self
     */
     ...
     * Sets time
     *
     * @param \DateTime|null $time The time when this historic detail occurred. Default [format](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the historic detail should be removed by the History Cleanup job. Default [format](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $root_process_instance_id The process instance id of the root process instance that initiated the process containing this historic detail.
     *
     * @return self
     */
     ...
     * Sets field_id
     *
     * @param string|null $field_id The id of the form field.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `formField`.
     *
     * @return self
     */
     ...
     * Sets field_value
     *
     * @param object|null $field_value The submitted form field value. The value differs depending on the form field's type and on the `deserializeValue` parameter.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `formField`.
     *
     * @return self
     */
     ...
     * Sets variable_name
     *
     * @param string|null $variable_name The name of the variable which has been updated.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     *
     * @param string|null $variable_instance_id The id of the associated variable instance.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     * Sets variable_type
     *
     * @param string|null $variable_type The value type of the variable.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param object|null $value The variable's value. Value differs depending on the variable's type and on the deserializeValues parameter.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     * Sets initial
     *
     * @param bool|null $initial Returns `true` for variable updates that contains the initial values of the variables.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     * Sets revision
     *
     * @param int|null $revision The revision of the historic variable update.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
     ...
     * Sets error_message
     *
     * @param string|null $error_message An error message in case a Java Serialized Object could not be de-serialized.  **Note:** This property is only set for a `HistoricVariableUpdate` historic details. In these cases, the value of the `type` property is `variableUpdate`.
     *
     * @return self
     */
