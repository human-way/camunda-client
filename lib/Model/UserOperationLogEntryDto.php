 ...
 */
class UserOperationLogEntryDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UserOperationLogEntryDto';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['org_value'] = $data['org_value'] ?? null;
     ...
     * Sets id
     *
     * @param string|null $id The unique identifier of this log entry.
     *
     * @return self
     */
     ...
     * Sets user_id
     *
     * @param string|null $user_id The user who performed this operation.
     *
     * @return self
     */
     ...
     * Sets timestamp
     *
     * @param \DateTime|null $timestamp Timestamp of this operation.
     *
     * @return self
     */
     ...
     * Sets operation_id
     *
     * @param string|null $operation_id The unique identifier of this operation. A composite operation that changes multiple properties has a common `operationId`.
     *
     * @return self
     */
     ...
     * Sets operation_type
     *
     * @param string|null $operation_type The type of this operation, e.g., `Assign`, `Claim` and so on.
     *
     * @return self
     */
     ...
     * Sets entity_type
     *
     * @param string|null $entity_type The type of the entity on which this operation was executed, e.g., `Task` or `Attachment`.
     *
     * @return self
     */
     ...
     * Sets category
     *
     * @param string|null $category The name of the category this operation was associated with, e.g., `TaskWorker` or `Admin`.
     *
     * @return self
     */
     ...
     * Sets annotation
     *
     * @param string|null $annotation An arbitrary annotation set by a user for auditing reasons.
     *
     * @return self
     */
     ...
     * Sets property
     *
     * @param string|null $property The property changed by this operation.
     *
     * @return self
     */
     ...
     * Sets org_value
     *
     * @param string|null $org_value The original value of the changed property.
     *
     * @return self
     */
     ...
     * Sets new_value
     *
     * @param string|null $new_value The new value of the changed property.
     *
     * @return self
     */
     ...
     * Sets deployment_id
     *
     * @param string|null $deployment_id If not `null`, the operation is restricted to entities in relation to this deployment.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_id If not `null`, the operation is restricted to entities in relation to this process definition.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_definition_key If not `null`, the operation is restricted to entities in relation to process definitions with this key.
     *
     * @return self
     */
     ...
     *
     * @param string|null $process_instance_id If not `null`, the operation is restricted to entities in relation to this process instance.
     *
     * @return self
     */
     ...
     * Sets execution_id
     *
     * @param string|null $execution_id If not `null`, the operation is restricted to entities in relation to this execution.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_definition_id If not `null`, the operation is restricted to entities in relation to this case definition.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_instance_id If not `null`, the operation is restricted to entities in relation to this case instance.
     *
     * @return self
     */
     ...
     *
     * @param string|null $case_execution_id If not `null`, the operation is restricted to entities in relation to this case execution.
     *
     * @return self
     */
     ...
     * Sets task_id
     *
     * @param string|null $task_id If not `null`, the operation is restricted to entities in relation to this task.
     *
     * @return self
     */
     ...
     *
     * @param string|null $external_task_id If not `null`, the operation is restricted to entities in relation to this external task.
     *
     * @return self
     */
     ...
     * Sets batch_id
     *
     * @param string|null $batch_id If not `null`, the operation is restricted to entities in relation to this batch.
     *
     * @return self
     */
     ...
     * Sets job_id
     *
     * @param string|null $job_id If not `null`, the operation is restricted to entities in relation to this job.
     *
     * @return self
     */
     ...
     *
     * @param string|null $job_definition_id If not `null`, the operation is restricted to entities in relation to this job definition.
     *
     * @return self
     */
