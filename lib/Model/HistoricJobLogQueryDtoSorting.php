 ...
 */
class HistoricJobLogQueryDtoSorting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricJobLogQueryDto_sorting';
