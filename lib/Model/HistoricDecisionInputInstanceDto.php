 ...
 */
class HistoricDecisionInputInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricDecisionInputInstanceDto';
     ...
     * Sets id
     *
     * @param string|null $id The id of the decision input value.
     *
     * @return self
     */
     ...
     *
     * @param string|null $decision_instance_id The id of the decision instance the input value belongs to.
     *
     * @return self
     */
     ...
     * Sets clause_id
     *
     * @param string|null $clause_id The id of the clause the input value belongs to.
     *
     * @return self
     */
     ...
     * Sets clause_name
     *
     * @param string|null $clause_name The name of the clause the input value belongs to.
     *
     * @return self
     */
