...
class AttachmentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the attachment should be removed by the History Cleanup job. [Default format](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/) `yyyy-MM-dd'T'HH:mm:ss.SSSZ`.
     *
     * @return self
     */
