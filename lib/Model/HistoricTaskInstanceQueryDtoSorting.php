 ...
 */
class HistoricTaskInstanceQueryDtoSorting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HistoricTaskInstanceQueryDto_sorting';
