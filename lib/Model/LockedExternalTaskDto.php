...
class LockedExternalTaskDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets variables
     *
     * @param array<string,\OpenAPI\Client\Model\VariableValueDto>|null $variables A JSON object containing a property for each of the requested variables. The key is the variable name, the value is a JSON object of serialized variable values with the following properties:
     *
     * @return self
     */
