...
class RestartProcessInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param bool|null $skip_io_mappings Skip execution of [input/output variable mappings](https://docs.camunda.org/manual/latest/user-guide/process-engine/variables/#input-output-variable-mapping) for activities that are started as part of this request.
     *
     * @return self
     */
