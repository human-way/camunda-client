...
class CaseDefinitionDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param int|null $history_time_to_live History time to live value of the case definition. Is used within [History cleanup](https://docs.camunda.org/manual/latest/user-guide/process-engine/history/#history-cleanup).
     *
     * @return self
     */
