 ...
 */
class JobDefinitionQueryDtoSorting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'JobDefinitionQueryDto_sorting';
