...
class IncidentDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \DateTime|null $incident_timestamp The time this incident happened. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
