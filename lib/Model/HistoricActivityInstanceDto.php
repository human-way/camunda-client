...
class HistoricActivityInstanceDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets start_time
     *
     * @param \DateTime|null $start_time The time the instance was started. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets end_time
     *
     * @param \DateTime|null $end_time The time the instance ended. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
     ...
     * Sets removal_time
     *
     * @param \DateTime|null $removal_time The time after which the activity instance should be removed by the History Cleanup job. By [default](https://docs.camunda.org/manual/latest/reference/rest/overview/date-format/), the date must have the format `yyyy-MM-dd'T'HH:mm:ss.SSSZ`, e.g., `2013-01-23T14:42:45.000+0200`.
     *
     * @return self
     */
